...
public class Zona {
	...
	public void vendre(int n) {
		if (this.entradesPerVendre ==0 ){
            System.out.println("Ho sentim, les entrades per la zona"
                                + "triada estan exhaurides.");
        } else if (this.entradesPerVendre < n){
            System.out.println("Nomes queden"+ this.entradesPerVendre
                                + " entrades per aquesta zona.");
        }
